...
なおかつ、本体を「Play画面・Stompモード」にしておくと、プリセットを切り替えた時に、そのプリセットで使われているエフェクターが本体の液晶モニターに一覧表示されて把握できるので、音のイメージがしやすい。Pod Go EDIT画面でエフェクターのアイコンを見たい場合、そのエフェクターをフットスイッチでオンオフすると、フォーカスが移ってアイコンが表示されます。  
- ポイント2：プリセットの数と配置  
