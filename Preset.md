...
なおかつ、Pod Go本体を「Play画面・Stompモード」にしておくと、Pod Go本体の液晶モニターに、そのプリセットで使われているエフェクターが一覧表示されるので、音のイメージがしやすい。Pod Go EDIT画面でエフェクターのアイコンを見たい場合、そのエフェクターをフットスイッチでオンオフすると、フォーカスが移ってアイコンが表示されます。  
- ポイント2：プリセットの数と配置  
