...
なおかつ、Pod Go本体を「Play画面・Stompモード」にしておくと、Pod Go本体の液晶モニターに、そのプリセットで使われているエフェクターの名称が一覧表示されるので、Presetの構成を把握しやすい。設定したいエフェクターをPod Go本体のフットスイッチでオンオフすると、Pod Go EDIT画面も連動してフォーカスが移って、アイコンやパラメーターが表示されます。設定するエフェクターを切り替えるのにいちいちマウス操作しなくてよいので、便利です。  
- ポイント2：プリセットの数と配置  
...
## Factory Preset 一覧
| No   | Bank | ABCD | Preset Name      | アンプ・モデル|備考|
| :--- | :--- | :--- | :--------------- | :--------------- | :--- |
| 1    | 1    | A    | US Deluxe Nrm    | ○                |      |
| 2    | 1    | B    | A30 Fawn Brt     | ○                |      |
