...
なおかつ、Pod Go本体を「Play画面・Stompモード」にしておくと、Pod Go本体の液晶モニターに、そのプリセットで使われているエフェクターが一覧表示されるので、音のイメージがしやすい。設定したいエフェクターをPod Go本体のフットスイッチでオンオフすると、Pod Go EDIT画面でもフォーカスが移ってアイコンやパラメーターが表示されます。エフェクターのアイコンを見たい場合も、いちいちマウス操作しなくてよいので便利です。  
- ポイント2：プリセットの数と配置  
